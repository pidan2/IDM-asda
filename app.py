...
def start_tryon(dict, garm_img, garment_des, is_checked, is_checked_crop, denoise_steps, seed):
    ...
    # 保存生成的图片
    #result_image_path = "output/result_image.png"  # 指定路径
    #result_image.save(result_image_path)  # 将图片提取出来，准备创建新的html文件，，，，还没试验
    # return images[0], mask_gray
...
with image_blocks as demo:
    ...
    with gr.Row():
        with gr.Column():
            imgs = gr.ImageEditor(sources='upload', type="pil", label='Human. Mask with pen or use auto-masking',
                                  interactive=True)
            with gr.Row():
        ...
        with gr.Column():
            ...
            with gr.Row(elem_id="prompt-container"):
                with gr.Row():
                    prompt = gr.Textbox(placeholder="Description of garment ex) Short Sleeve Round Neck T-shirts",
